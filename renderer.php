...
class block_opencast_renderer extends plugin_renderer_base
{
    ...
    public function render_edit_functions($courseid, $videoidentifier, $updatemetadata, $startworkflows)
    {
        ...
        if ($updatemetadata) {
            ...
            $actionmenu->add(new action_menu_link_secondary(
                new \moodle_url('/blocks/opencast/updatemetadata.php', array('video_identifier' => $videoidentifier, 'courseid' => $courseid)),
    ...
    public function render_workflow_admin_checkbox($id, $checked, $title, $description, $info = null, $error = null)
    {

        $context = (object)[
            "label" => $title,
            "name" => $id,
            "default" => get_string('defaultsettinginfo', 'admin', get_string('checkboxno', 'admin')),
            "id" => $id,
            "checked" => $checked,
        ...
        return $this->render_from_template('block_opencast/workflow_settings_checkbox', $context);
    }
