...
$string['importvideos_settinghandleepisodeenabled_desc'] = 'If enabled, teachers can handle Opencast episode modules which relate to the videos which are imported. This especially cleans up modules which have been imported from one course to another course but which still link to videos in the old course.';
$string['importvideos_settinghandleseriesenabled'] = 'Handle Opencast series modules during manual video import';
$string['importvideos_settinghandleseriesenabled_desc'] = 'If enabled, teachers can handle Opencast series modules which relate to the videos which are imported. This especially cleans up modules which have been imported from one course to another course but which still link to the course series of the old course.';
