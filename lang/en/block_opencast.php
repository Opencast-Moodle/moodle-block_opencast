...
$string['addlti_modulecreated'] = 'The \'{$a}\' LTI module has been added to this course.';
$string['addlti_moduleexists'] = 'There is already an Opencast LTI module added to this course. There is no need to add another one.';
$string['addlti_modulenotcreated'] = 'The \'{$a}\' LTI module could not be created. Please try again or contact your Moodle administrator.';
$string['addlti_addbuttonexplanation'] = 'The videos which are added to and are available in this course are not provided to your students automatically.<br />Here, you can add a LTI module to your course which provides all available videos as an Opencast series list to your students.';
$string['addlti_addbuttontitle'] = 'Add Opencast LTI module to course';
$string['addlti_defaulttitle'] = 'Opencast videos';
$string['addlti_formltititle'] = 'Opencast LTI module title';
$string['addlti_header'] = 'Provide videos';
$string['addlti_noemptytitle'] = 'You have to set a title for the Opencast LTI module or to use the default title ("{$a}")';
...
$string['addlti_viewbuttonexplanation'] = 'An Opencast LTI module to provide the videos available in this course has been added to the course before.';
$string['addlti_viewbuttontitle'] = 'View Opencast LTI module in course';
...
$string['opencast:addlti'] = 'Add LTI module to course';
