...
$string['keepseriesmappingblockdelete'] = 'Keep serie mapping after deleting the block';
$string['keepseriesmappingblockdelete_desc'] = 'If enabled, deleting a block within a course will not remove the associated series mapping records. This allows you to manually delete a block from a course and later retrieve the series by adding back the block again.<br><b>NOTE:</b> For administrators, it\'s recommended to use this feature with caution, as it may lead to delays or an accumulation of records in the seriesmapping table. Keeping this option in mind can prove helpful during debugging or when encountering potential performance issues.';
