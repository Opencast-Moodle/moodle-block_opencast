...
$string['lticonsumerkey_desc'] = 'LTI Consumer key';
$string['lticonsumersecret'] = 'Consumer secret';
$string['lticonsumersecret_desc'] = 'LTI Consumer secret';
$string['ltiengageurl'] = 'URL of the Opencast Engage server';
$string['ltiengageurl_desc'] = 'If empty, the base URL of the admin tool is used.';