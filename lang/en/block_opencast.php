...
$string['addactivity_addbuttonexplanation'] = 'The videos which are added to and are available in this course are not provided to your students automatically.<br />Here, you can add an Opencast series module to your course which provides all available videos as an Opencast series list to your students.';
$string['addactivity_addbuttontitle'] = 'Add Opencast series module to course';
...
$string['addactivity_header'] = 'Provide videos';
...
$string['addactivity_settingavailability_desc'] = 'If enabled, teachers can set the availability conditions when a new Opencast LTI series module is added to a course.';
...
$string['addactivity_settingdefaulttitle'] = 'Default LTI series module title';
$string['addactivity_settingdefaulttitle_desc'] = 'The default title to be used when a new Opencast LTI series module is added to a course.';
...
$string['addactivityepisode_settingenabled_desc'] = 'If enabled, teachers can add an Opencast LTI episode module to a course. This Opencast Activity episode module will be pointing to an Opencast episode.';
