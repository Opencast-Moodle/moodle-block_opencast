...
$string['presenterdesc'] = 'Use the presenter video if you have a video file of a person speaking to an audience or a motion picture.<br />The presenter video will be encoded in motion picture quality.';
$string['presentation'] = 'Presentation video';
$string['presentationdesc'] = 'Use the presentation video if you have a video file of a slide presentation recording or a screencast.<br />The presentation video will be encoded in good quality. Additionally, the presentation video will be postprocessed to create preview thumbnails of each slide change.';
