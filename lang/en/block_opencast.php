...
$string['groupnamedesc'] = 'Group to which the video is added. Important: The group name length is restricted to 128 Bytes.';
...
$string['seriesnamedesc'] = 'Series to which the video is added.';
