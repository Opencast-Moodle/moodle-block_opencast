...
$string['importmodedesc'] = 'In order to define an approach to import videos into a course, a mode should be seleted. The default mode is Duplication Event in which a new series would be created and events will be avaible in the series by using a dupliaction workflow. <br /> ACL change approach on the other hand will use the same series id but events\' ACLs are changes to grant access from the course which imports the videos.';
...
$string['importvideos_importjobaclchangedone'] = 'The import of the selected series with its videos into this course has been done. You can now access the videos from the list.';
$string['importvideos_importjobaclchangeseriesfailed'] = 'Import failed, because the ACL change for seleceted series has failed.';
...
$string['importvideos_settingmanualaclenabled'] = 'Allow manual video import in ACL Change Mode';
$string['importvideos_settingmanualaclenabled_desc'] = 'If enabled, teachers can import existing video files from other Moodle courses to their Moodle course by using a dedicated Opencast video import wizard. This feature is offered on the Opencast block overview page. Using this feature, the Series id of the the target course will be used in the new course and the ACLs for all its videos will be changed in order to grant access to them within the new course.<br />Unlike in Duplicating Events Mode, there is no manuall selection of videos available within the provided wizard.<br />Please note that there are corresponding capabilities block/opencast:manualimporttarget and block/opencast:manualimportsource for this feature which control who can import which courses to which courses. By default, managers and editing teachers have this capability and can use the feature as soon as it is enabled here.';
...
$string['importvideos_wizardstep2aclheading'] = 'Summary';
$string['importvideos_wizardstep2aclintro'] = 'Please verify that the summary of the video import matches your expectations before you run the import.';
