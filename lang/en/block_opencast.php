...
$string['appearance_overview_settingshowtablelegend'] = 'Show table column legends';
$string['appearance_overview_settingshowtablelegend_desc'] = 'If enabled, the column legend for the available videos table will be shown in the overview page, placed right below the table.';
...
$string['legenddeletingdesc'] = 'Deleting in progress';
...
$string['legendplanneddesc'] = 'Video has been scheduled for processing';
...
$string['legendocstatefaileddesc'] = 'Processing failed';
$string['ocstateprocessing'] = 'Processing';
$string['legendocstateprocessingdesc'] = 'Processing in progress';
$string['ocstatesucceeded'] = 'Succeeded';
$string['legendocstatesucceededdesc'] = 'Processing done';
...
$string['legendocstateneedscuttingdesc'] = 'Video requires further attention';
...
// Legend modal title.
$string['legendtitle'] = 'Legend Details Table';
