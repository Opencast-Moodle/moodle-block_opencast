...
$string['attachmentssaved'] = 'Attachment(s) uploaded.';
...
$string['creatingmediapackagefailed'] = 'Creation of media pacakge failed';
...
$string['ingestingmediapackagefailed'] = 'Ingestion of media pacakge failed';
...
$string['mstatewaitingforworkflowpreattachments'] = 'Video processing, waiting to upload attachments...';
...
$string['noattachmentfieldsdefined'] = 'No attachment fields are defined.';
...
$string['workflownotstarted:attachments'] = 'The workflow to upload attachments to the video ({$a->eventid}) assigned to course {$a->coursefullname} (ID: {$a->courseid}) could not be started.';
...
$string['attachmentoverwritenotice'] = 'Notice: By uploading attachments you can overwrite existing ones. If an attachment has already been uploaded for a certain field, uploading another one for the same field will overwrite the previous attachment.';