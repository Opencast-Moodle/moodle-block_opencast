...
// $string['maxtranscriptionuploadreached'] = 'It is not possible to add another transcription upload fields.';
...
$string['transcriptionheaderexplanation'] = 'In this section you are able to upload a transcription file for as many language as you want, with specified file extension, which then will be uploaded alongside the video and be processed accordingly to provide the (speech to text) capability.';
$string['transcriptionaddnewbtn'] = 'Add more transcription set';
$string['transcriptiondeletebtn'] = 'Delete transcription set';
$string['transcriptionlangfield'] = 'Transcription language';
$string['transcriptionfilefield'] = 'Transcription file';
$string['emptylanguageoption'] = 'Please select a language';
...
$string['unabletomanagetranscriptions'] = 'Unable to manage event\'s transcriptions at the moment';
$string['addnewtranscription'] = 'Add new transcription';
$string['addnewtranscription_desc'] = 'Please select a language in which your transcription should be represented, and then upload the file with designated extensions.';
...
$string['transcriptionlang_thead'] = 'Language';
$string['notranscriptionlanguage'] = 'Unknown Language';
