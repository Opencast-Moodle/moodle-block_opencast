...
function xmldb_block_opencast_upgrade($oldversion) {
    ...
    if ($oldversion < 2021071200) {
        ...
        $table->add_field('notified', XMLDB_TYPE_INTEGER, '1', null, null, null, null);
        $table->add_field('timecreated', XMLDB_TYPE_INTEGER, '10', null, XMLDB_NOTNULL, null, null);
        $table->add_field('timenotified', XMLDB_TYPE_INTEGER, '10', null, null, null, null);
        ...
        // Opencast savepoint reached.
        upgrade_block_savepoint(true, 2021071200, 'opencast');
    }
