...
class updatemetadata_form extends \moodleform {
    ...
    public function definition() {
        ...
        $languages = $this->_customdata['languages'] ? json_decode($this->_customdata['languages']->param_json, true) : [
            "" => "No option selected",
            "slv" => ucwords(strtolower("SLOVENIAN")),
            "por" => ucwords(strtolower("PORTUGESE")),
            "roh" => ucwords(strtolower("ROMANSH")),
            "ara" => ucwords(strtolower("ARABIC")),
            "pol" => ucwords(strtolower("POLISH")),
            "ita" => ucwords(strtolower("ITALIAN")),
            "zho" => ucwords(strtolower("CHINESE")),
            "fin" => ucwords(strtolower("FINNISH")),
            "dan" => ucwords(strtolower("DANISH")),
            "ukr" => ucwords(strtolower("UKRAINIAN")),
            "fra" => ucwords(strtolower("FRENCH")),
            "spa" => ucwords(strtolower("SPANISH")),
            "gsw" => ucwords(strtolower("SWISS GERMAN")),
            "nor" => ucwords(strtolower("NORWEGIAN")),
            "rus" => ucwords(strtolower("RUSSIAN")),
            "jpx" => ucwords(strtolower("JAPANESE")),
            "nld" => ucwords(strtolower("DUTCH")),
            "tur" => ucwords(strtolower("TURKISH")),
            "hin" => ucwords(strtolower("HINDI")),
            "swa" => ucwords(strtolower("SWEDISH")),
            "eng" => ucwords(strtolower("ENGLISH")),
            "deu" => ucwords(strtolower("GERMAN"))
        ];
        ...
        foreach ($metadata as $field) {
            ...
            if ($field->id == 'description') {$type = 'textarea';}
