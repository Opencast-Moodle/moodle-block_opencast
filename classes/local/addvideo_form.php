    ...
    public function definition() {
        ...
        $mform->addElement('header', 'upload_filepicker', get_string('upload', 'block_opencast'));
            ...
            $mform->addElement('filepicker', 'video_presenter',
                get_string('presentervideostoupload', 'block_opencast'), null,array('accepted_types' => array('*')));

            $mform->addElement('filepicker', 'video_presentation',
                get_string('presentationvideostoupload', 'block_opencast'), null, array('accepted_types' => array('*')));
